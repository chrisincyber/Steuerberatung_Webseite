...
export const translations = {
  de: {
    ...
    withholding: {
      ...
      disclaimer: 'Vereinfachte Berechnung. Die tatsächliche Quellensteuer hängt vom Tarif Ihres Kantons ab.',
  ...
  en: {
    ...
    withholding: {
      ...
      disclaimer: 'Simplified calculation. Actual withholding tax depends on your canton\'s tariff.',
